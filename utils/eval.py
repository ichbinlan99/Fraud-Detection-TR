...
def card_precision_top_k(predictions_df, top_k, remove_detected_compromised_cards=True):
    ...
    tuple: A tuple containing:
        - nb_compromised_cards_per_day (list): List of the number of unique compromised cards per day.
...
def performance_assessment(predictions_df, output_feature='is_fraud', 
    ...
    Parameters:
    predictions_df (pd.DataFrame): DataFrame containing the true labels and predicted scores.
